...
\hypertitle{fr}{Chimie organique}{4}{MAPR}{1230}
{Damien Hoedenaeken}
...
L'effet mésomère (ou résonance) est le phénomène qui est la cause de la stabilité du benzène.
Cette molécule est plus stable, d'environ 151kJ/mol, que si l'on considérait la molécule sans résonnance.
Le benzène possède une structure plane et chaque atome de carbone est situé à l'un des sommets d'un hexagone régulier.
La longueur des liaisons carbone-carbone est identique, soit 139pm, ce qui ne peut s'expliquer sans la résonnace.
En effet, les liaisons doubles sont toujours plus courte que les liaisons simples.

L'effet mésomère n'existe que dans les trois cas suivants :
\begin{itemize}
 \item Présence de doublets d'électrons libres sur un atome ou anion
 \item Présence d'électrons $\pi$
 \item Présence de charges positives
\end{itemize}
