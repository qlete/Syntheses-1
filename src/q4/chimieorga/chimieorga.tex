...
\begin{table}[h]
  \begin{center}
    ...
    \hline
    $sp$ & linéaire & $180^\circ$ \\
    \hline
    $sp^2$ & triangulaire & $120^\circ$ \\
    \hline
    $sp^3$ & tétrahédrique & $109.5^\circ$ \\
    \hline
    \end{tabular}
...
Le suffixe est -one si il n'y a pas de groupe de plus grande priorité
...
\begin{itemize}
  ...
  \item a un système conjugué sur l'ensemble de cycle (pas de C $sp^3$).
  \item contient 4n + 2 électrons délocalisables ( électron $\pi$ ou des doublets d'électron libre). Si n n'est pas entier, le composé n'est pas aromatique.
  \item est plan
\end{itemize}
